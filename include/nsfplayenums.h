...
const int32_t NSF_ERROR_RAW_ERROR =                               599;
const int32_t NSF_ERROR_SET_INVALID =                             600;
const int32_t NSF_ERROR_SET_TYPE =                                601;
const int32_t NSF_ERROR_SETINT_RANGE =                            602;
const int32_t NSF_ERROR_INI_NOTEXT =                              603;
const int32_t NSF_ERROR_INI_NO_EQUALS =                           604;
const int32_t NSF_ERROR_INI_BAD_KEY =                             605;
const int32_t NSF_ERROR_INI_BAD_INT =                             606;
const int32_t NSF_ERROR_INI_BAD_RANGE =                           607;
const int32_t NSF_ERROR_INI_BAD_LIST_KEY =                        608;
const int32_t NSF_ERROR_INI_BAD_WRITE =                           609;
const int32_t NSF_ERROR_BIN_BAD =                                 610;
const int32_t NSF_ERROR_NSF_HEAD_BAD =                            611;
const int32_t NSF_ERROR_NSF_VERSION_BAD =                         612;
const int32_t NSF_ERROR_NSF2_META_BAD =                           613;
const int32_t NSF_ERROR_NSF_HEAD_TEXT_BAD =                       614;
const int32_t NSF_ERROR_NSFE_CHUNK_BAD =                          615;
const int32_t NSF_ERROR_NSFE_MANDATORY =                          616;
const int32_t NSF_ERROR_NSFE_NO_MANDATORY =                       617;
const int32_t NSF_TEXT_COUNT =                                    618;
