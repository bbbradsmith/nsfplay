...
const int32_t NSF_TEXT_MENU_FILE =                                602;
const int32_t NSF_TEXT_MENU_VIEW =                                603;
const int32_t NSF_TEXT_MENU_OPTIONS =                             604;
const int32_t NSF_TEXT_MENU_ABOUT =                               605;
const int32_t NSF_TEXT_MENU_CHANNELS =                            606;
const int32_t NSF_TEXT_MENU_MEMORY =                              607;
const int32_t NSF_TEXT_MENU_LOG =                                 608;
const int32_t NSF_TEXT_MENU_KEYBOARD =                            609;
const int32_t NSF_TEXT_MENU_DEBUGGER =                            610;
const int32_t NSF_TEXT_MENU_OPEN =                                611;
const int32_t NSF_TEXT_MENU_INI_LOAD =                            612;
const int32_t NSF_TEXT_MENU_INI_SAVE =                            613;
const int32_t NSF_ERROR_RAW_ERROR =                               614;
const int32_t NSF_ERROR_SET_INVALID =                             615;
const int32_t NSF_ERROR_SET_TYPE =                                616;
const int32_t NSF_ERROR_SETINT_RANGE =                            617;
const int32_t NSF_ERROR_INI_NOTEXT =                              618;
const int32_t NSF_ERROR_INI_NO_EQUALS =                           619;
const int32_t NSF_ERROR_INI_BAD_KEY =                             620;
const int32_t NSF_ERROR_INI_BAD_INT =                             621;
const int32_t NSF_ERROR_INI_BAD_RANGE =                           622;
const int32_t NSF_ERROR_INI_BAD_LIST_KEY =                        623;
const int32_t NSF_ERROR_INI_BAD_WRITE =                           624;
const int32_t NSF_ERROR_BIN_BAD =                                 625;
const int32_t NSF_ERROR_NSF_HEAD_BAD =                            626;
const int32_t NSF_ERROR_NSF_VERSION_BAD =                         627;
const int32_t NSF_ERROR_NSF2_META_BAD =                           628;
const int32_t NSF_ERROR_NSF_HEAD_TEXT_BAD =                       629;
const int32_t NSF_ERROR_NSFE_CHUNK_BAD =                          630;
const int32_t NSF_ERROR_NSFE_MANDATORY =                          631;
const int32_t NSF_ERROR_NSFE_NO_MANDATORY =                       632;
const int32_t NSF_TEXT_COUNT =                                    633;
