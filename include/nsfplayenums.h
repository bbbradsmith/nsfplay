...
const int32_t NSF_PROP_COUNT =                                     58;
...
const int32_t NSF_PROP_TEST_INT =                                  40;
const int32_t NSF_PROP_TEST_LONG =                                 41;
const int32_t NSF_PROP_TEST_STR =                                  42;
const int32_t NSF_PROP_TEST_LINES =                                43;
const int32_t NSF_PROP_TEST_BLOB =                                 44;
const int32_t NSF_PROP_TEST_LIST =                                 45;
const int32_t NSF_PROP_TEST_HEX8 =                                 46;
const int32_t NSF_PROP_TEST_HEX16 =                                47;
const int32_t NSF_PROP_TEST_HEX32 =                                48;
const int32_t NSF_PROP_TEXT_HEX64 =                                49;
const int32_t NSF_PROP_TEST_COLOR =                                50;
const int32_t NSF_PROP_TEST_MSEC =                                 51;
const int32_t NSF_PROP_TEST_MILL =                                 52;
const int32_t NSF_PROP_TEST_HZ =                                   53;
const int32_t NSF_PROP_TEST_KEY =                                  54;
const int32_t NSF_PROP_TEST_PRECISE =                              55;
const int32_t NSF_PROP_TEST_PRDMILL =                              56;
const int32_t NSF_PROP_SONG_TITLE =                                57;

const int32_t NSF_TEXT_MENU_FILE =                                583;
const int32_t NSF_TEXT_MENU_VIEW =                                584;
const int32_t NSF_TEXT_MENU_OPTIONS =                             585;
const int32_t NSF_TEXT_MENU_ABOUT =                               586;
const int32_t NSF_TEXT_MENU_CHANNELS =                            587;
const int32_t NSF_TEXT_MENU_MEMORY =                              588;
const int32_t NSF_TEXT_MENU_LOG =                                 589;
const int32_t NSF_TEXT_MENU_KEYBOARD =                            590;
const int32_t NSF_TEXT_MENU_DEBUGGER =                            591;
const int32_t NSF_TEXT_MENU_OPEN =                                592;
const int32_t NSF_TEXT_MENU_INI_LOAD =                            593;
const int32_t NSF_TEXT_MENU_INI_SAVE =                            594;
const int32_t NSF_ERROR_SET_INVALID =                             595;
const int32_t NSF_ERROR_SET_TYPE =                                596;
const int32_t NSF_ERROR_SETINT_RANGE =                            597;
const int32_t NSF_ERROR_INI_NO_EQUALS =                           598;
const int32_t NSF_ERROR_INI_BAD_KEY =                             599;
const int32_t NSF_ERROR_INI_BAD_INT =                             600;
const int32_t NSF_ERROR_INI_BAD_RANGE =                           601;
const int32_t NSF_ERROR_INI_BAD_LIST_KEY =                        602;
const int32_t NSF_ERROR_BIN_BAD =                                 603;
const int32_t NSF_ERROR_NSF_HEAD_BAD =                            604;
const int32_t NSF_ERROR_NSF_VERSION_BAD =                         605;
const int32_t NSF_ERROR_NSF2_META_BAD =                           606;
const int32_t NSF_ERROR_NSF_HEAD_TEXT_BAD =                       607;
const int32_t NSF_ERROR_NSFE_CHUNK_BAD =                          608;
const int32_t NSF_ERROR_NSFE_MANDATORY =                          609;
const int32_t NSF_ERROR_NSFE_NO_MANDATORY =                       610;
const int32_t NSF_TEXT_COUNT =                                    611;
