...
const int32_t NSF_ERROR_OUT_OF_MEMORY =                           630;
const int32_t NSF_ERROR_SET_INVALID =                             631;
const int32_t NSF_ERROR_SET_TYPE =                                632;
const int32_t NSF_ERROR_SETINT_RANGE =                            633;
const int32_t NSF_ERROR_INI_NOTEXT =                              634;
const int32_t NSF_ERROR_INI_NO_EQUALS =                           635;
const int32_t NSF_ERROR_INI_BAD_KEY =                             636;
const int32_t NSF_ERROR_INI_BAD_INT =                             637;
const int32_t NSF_ERROR_INI_BAD_RANGE =                           638;
const int32_t NSF_ERROR_INI_BAD_LIST_KEY =                        639;
const int32_t NSF_ERROR_INI_BAD_WRITE =                           640;
const int32_t NSF_ERROR_BIN_BAD =                                 641;
const int32_t NSF_ERROR_NSF_HEAD_BAD =                            642;
const int32_t NSF_ERROR_NSF_VERSION_BAD =                         643;
const int32_t NSF_ERROR_NSF2_META_BAD =                           644;
const int32_t NSF_ERROR_NSF_HEAD_TEXT_BAD =                       645;
const int32_t NSF_ERROR_NSFE_CHUNK_BAD =                          646;
const int32_t NSF_ERROR_NSFE_MANDATORY =                          647;
const int32_t NSF_ERROR_NSFE_NO_MANDATORY =                       648;
const int32_t NSF_TEXT_COUNT =                                    649;
