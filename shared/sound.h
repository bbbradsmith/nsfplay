...
int sound_device_count(); // use between sound_setup/shutdown
SoundDeviceInfo sound_device_info(int device); // use between sound_setup/shutdown
SoundStreamInfo sound_stream_info(); // use between sound_start/stop
...
bool sound_setup(); // initializes library
bool sound_start(const NSFCore* core); // stream begins
